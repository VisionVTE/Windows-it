# PowerShell Driver Uninstallation Script for Apple A18 Pro USB Driver
...
Write-Status "==================================================" "Cyan"
Write-Status "Apple A18 Pro USB Driver Uninstallation" "Cyan"
Write-Status "==================================================" "Cyan"

try {
    $targetDrivers = Get-WindowsDriver -Online -All | Where-Object { $_.OriginalFileName -match "AppleA18ProUsb\.inf" }
    if ($null -ne $targetDrivers -and $targetDrivers.Count -gt 0) {
        ...
        Write-Status "No matching USB driver found in the Windows Driver Store." "Yellow"
    }
} catch {
...
Write-Status "==================================================" "Cyan"
Write-Status "USB uninstallation complete!" "Green"
Write-Status "==================================================" "Cyan"
