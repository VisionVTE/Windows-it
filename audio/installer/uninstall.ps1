# PowerShell Driver Uninstallation Script for Apple A18 Pro Audio Driver
...
Write-Status "==================================================" "Cyan"
Write-Status "Apple A18 Pro Audio Driver Uninstallation" "Cyan"
Write-Status "==================================================" "Cyan"

try {
    $targetDrivers = Get-WindowsDriver -Online -All | Where-Object { $_.OriginalFileName -match "AppleA18ProAudio\.inf" }
    if ($null -ne $targetDrivers -and $targetDrivers.Count -gt 0) {
        ...
        Write-Status "No matching audio driver found in the Windows Driver Store." "Yellow"
    }
} catch {
...
Write-Status "==================================================" "Cyan"
Write-Status "Audio uninstallation complete!" "Green"
Write-Status "==================================================" "Cyan"
