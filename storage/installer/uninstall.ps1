# PowerShell Driver Uninstallation Script for Apple A18 Pro Storage Driver
...
Write-Status "==================================================" "Cyan"
Write-Status "Apple A18 Pro Storage Driver Uninstallation" "Cyan"
Write-Status "==================================================" "Cyan"

try {
    $targetDrivers = Get-WindowsDriver -Online -All | Where-Object { $_.OriginalFileName -match "AppleA18ProStorage\.inf" }
    if ($null -ne $targetDrivers -and $targetDrivers.Count -gt 0) {
        ...
        Write-Status "No matching storage driver found in the Windows Driver Store." "Yellow"
    }
} catch {
    Write-Status "An error occurred during driver package removal: $_" "Red"
}

# Shared Certificate Management: If no other drivers are installed, clean it up.
...
Write-Status "==================================================" "Cyan"
Write-Status "Storage uninstallation complete!" "Green"
Write-Status "==================================================" "Cyan"
